...
MCP-сервер для Kaiten API. 178 инструментов: карточки, доски, проекты, документы, автоматизации, Service Desk и др.
...
Скажи пользователю: выйди из Claude Code (`/exit`) и запусти заново. Инструменты Kaiten (178 шт.) появятся после перезапуска.
...
Когда MCP-сервер подключён и Claude Code перезапущен, доступны 178 инструментов. Типичные сценарии:
